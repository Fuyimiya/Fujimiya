...
import SininhoNotificacao from './SininhoNotificacao'; // <-- Importa o componente que criamos
          ...
          {user ? (
            <>
              ...
              <div className="pt-2 border-t border-emerald-50">
                ...
                {user.perfil === "GESTOR" && (
                  <div className="mb-4 flex items-center justify-between p-2 bg-emerald-50/50 rounded-lg">
                    <span className="text-sm font-semibold text-emerald-800">Alertas urgentes:</span>
                    <SininhoNotificacao />
                  </div>
                )}
